# 1 "C:\\Users\\osman\\AppData\\Local\\Temp\\tmpfejm_xti"
#include <Arduino.h>
# 1 "C:/Esp32-Code/esp32_marauder/esp32_marauder.ino"
...
void setup();
void loop();
#line 126 "C:/Esp32-Code/esp32_marauder/esp32_marauder.ino"
void backlightOn() {
#ifdef HAS_SCREEN
...
void setup() {
  ...
  display_obj.tft.drawCentreString("ESP32 Marauder", TFT_WIDTH / 2,
                                   TFT_HEIGHT * 0.33, 1);
  display_obj.tft.drawCentreString("ESP32-Project", TFT_WIDTH / 2,
                                   TFT_HEIGHT * 0.5, 1);
  display_obj.tft.drawCentreString(display_obj.version_number, TFT_WIDTH / 2,
                                   TFT_HEIGHT * 0.66, 1);
#else
  display_obj.tft.drawCentreString("ESP32 Marauder", TFT_HEIGHT / 2,
                                   TFT_WIDTH * 0.33, 1);
  display_obj.tft.drawCentreString("ESP32-Project", TFT_HEIGHT / 2,
                                   TFT_WIDTH * 0.5, 1);
  display_obj.tft.drawCentreString(display_obj.version_number, TFT_HEIGHT / 2,
                                   TFT_WIDTH * 0.66, 1);
#endif
#endif
  ...
  if (settings_obj.getSettingType("ChanHop") == "") {
    Serial.println(F("Current settings format not supported. Installing new "
                     "default settings..."));
  ...
  display_obj.tft.drawCentreString("Initializing...", TFT_WIDTH / 2,
                                   TFT_HEIGHT * 0.82, 1);
#endif
...
#endif
# 343 "C:/Esp32-Code/esp32_marauder/esp32_marauder.ino"
