...
#define GPS_SERIAL_INDEX 2
#define GPS_TX                                                                 \
  22 // Whoever thought it would be a good idea to use UART0 for GPS...
...
//   #define BUF_SIZE 8 * 1024 // Had to reduce buffer size to save RAM. GG
//   @spacehuhn #define SNAP_LEN 4096 // max len of each recieved packet
#else
#define BUF_SIZE                                                               \
