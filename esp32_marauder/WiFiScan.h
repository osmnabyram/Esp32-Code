...
#define BT_ATTACK_APPLE_JUICE BT_ATTACK_SOUR_APPLE
...
#define WIFI_SCAN_PASSIVE_DISCOVERY 82
...
class WiFiScan
{
  private:
    ...
    uint32_t last_mac_rotation_time = 0;
  ...
  public:
    std::vector<String> discovery_seen_macs;
    String dynamic_redirect_url = "";
    void RunPassiveDiscovery(uint8_t scan_mode, uint16_t color);
    ...
    static void passiveDiscoveryCallback(void* buf, wifi_promiscuous_pkt_type_t type);
